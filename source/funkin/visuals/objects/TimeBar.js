export class TimeBar {
    constructor(scene) {
        ...
        this.recorte = 8;
        this.barHeight = 30;
        this.scaleFactor = 1.1; // Escala actualizada
    }
    ...
    _centerElements() {
        ...
        let yPosition;
        if (downScroll) {
            // Coloca la barra en la parte inferior, despegada 10px
            yPosition = this.scene.cameras.main.height - (this.barHeight * this.scaleFactor) - 10;
        } else {
            // Arriba por defecto
            yPosition = 10;
        }
